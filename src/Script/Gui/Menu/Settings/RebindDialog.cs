...
{
    public class RebindDialog : PanelContainer
    {
        ...
        public InputEvent ActionToRebind
        {
            ...
            set
            {
                ...
                NewBindLabel.Text = "Rebind: " + ControlsTab.ConvertButtonText(value);
            }
        }
        ...
        public string ActionNameToRebind
        {
            ...
            set
            {
                ...
                NameLabel.Text = ControlsTab.ConvertActionName(value);
            }
        }
        ...
        public void OnAcceptPressed()
        {
            ...
            ((Button) ControlsTab.NameToRowControl[ActionNameToRebind].InputObject).Text =
